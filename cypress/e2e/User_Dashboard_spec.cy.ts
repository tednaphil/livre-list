describe('Logged-in User Stories Spec', () => {
    ...
    it('Logs a user in', () => {
        ...
        .get('.chakra-alert').should('be.visible').contains('You\'re logged in! Welcome')
        .get('a[href="/shelves"]').contains('Shelves').should('be.visible')
        .get('.chakra-button').contains('Logout').should('be.visible')
        .wait(800).get('.chakra-alert').should('not.exist')
    })
    ...
    it('Logs a user out', () => {
        ...
        .get('.chakra-alert').should('be.visible').contains('You\'ve logged out! See ya')
